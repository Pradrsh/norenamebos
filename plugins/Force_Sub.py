...
async def not_user(_, client, message):
...
async def not_subscribed(_, client, message):
    ...
    try:             
        ...
        pass
    return True
@Client.on_message(filters.private & filters.create(not_user))
async def personal_use(client, message):
  buttons = [[InlineKeyboardButton(text="📢 Create your own bot📢", url=f"https://t.me/nobody_ismy_name") ]]
  text = "ꜱᴏʀʀʏ ʙʀᴏ, ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ꜰᴏʀ ᴘᴇʀꜱᴏɴᴀʟ ᴜꜱᴇ ᴏɴʟʏ "
